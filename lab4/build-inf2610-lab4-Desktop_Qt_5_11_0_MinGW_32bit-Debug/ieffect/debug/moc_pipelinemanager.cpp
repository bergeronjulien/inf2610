...
void PipelineManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (PipelineManager::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PipelineManager::done)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject PipelineManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_PipelineManager.data,
      qt_meta_data_PipelineManager,  qt_static_metacall, nullptr, nullptr}
};
