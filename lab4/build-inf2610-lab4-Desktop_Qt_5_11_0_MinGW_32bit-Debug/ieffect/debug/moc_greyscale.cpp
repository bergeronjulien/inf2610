...
QT_INIT_METAOBJECT const QMetaObject GreyScale::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_GreyScale.data,
      qt_meta_data_GreyScale,  qt_static_metacall, nullptr, nullptr}
};
...
void *GreyScale::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "ImageEffect"))
        return static_cast< ImageEffect*>(this);
